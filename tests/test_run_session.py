...
class MyTestCase(unittest.TestCase):
    def test_session_setup(self):
        ...
        self.assertEqual(session.macke_counter, 0, message.format("macke_counter"))
        self.assertEqual(session.game_counter, 0, message.format("game_counter"))
    ...
    def test_play_until_5k(self):
        ...
        self.assertTrue(session.game_counter == 14)
        self.assertTrue(session.macke_counter == 4)
